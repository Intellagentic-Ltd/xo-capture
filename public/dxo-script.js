...
// =========================================================================
// v4.5 — Mayo Clinic demo client, four-section spine, precise selectors.
...
//   - Sidebar nav items (Enrich, Configuration) targeted via `text:`
//     until a follow-up adds nav-* anchors.
...
window.DXO_SCRIPT = {
  meta: {
    ...
    version: "4.5.0",
    notes: "v4.5: precise selectors for Streamline/XO sub-blocks via existing DOM ids.",
  },
